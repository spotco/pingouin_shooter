...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("sdaf", "pingouinshooter", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "pingouin_shooter", null, { width: 1000, height: 500 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 1000, height: 500 });
			#end
