...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/char/player_top/main_character_default.plist", __ASSET__assets_images_char_player_top_main_character_default_plist);
		type.set ("assets/images/char/player_top/main_character_default.plist", Reflect.field (AssetType, "text".toUpperCase ()));
		className.set ("assets/images/char/player_top/main_character_default.png", __ASSET__assets_images_char_player_top_main_character_default_png);
		...
		addExternal("assets/images/char/player_top/main_character_default.plist", "text", "assets/images/char/player_top/main_character_default.plist");
		addExternal("assets/images/char/player_top/main_character_default.png", "image", "assets/images/char/player_top/main_character_default.png");
...
@:keep class __ASSET__assets_images_char_player_top_main_character_default_plist extends null { }
@:keep class __ASSET__assets_images_char_player_top_main_character_default_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep class __ASSET__assets_music_bottom1_mp3 extends null { }
@:keep class __ASSET__assets_music_bottom2_mp3 extends null { }
@:keep class __ASSET__assets_music_bottom3_mp3 extends null { }
@:keep class __ASSET__assets_music_bottom4_mp3 extends null { }
@:keep class __ASSET__assets_music_ss_3_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_music_top_mp3 extends null { }
@:keep class __ASSET__assets_sounds_sfx_bone_1_mp3 extends null { }
@:keep class __ASSET__assets_sounds_sfx_bone_2_mp3 extends null { }
@:keep class __ASSET__assets_sounds_sfx_bone_3_mp3 extends null { }
@:keep class __ASSET__assets_sounds_sfx_bone_4_mp3 extends null { }
@:keep class __ASSET__assets_sounds_sfx_explosion_mp3 extends null { }
@:keep class __ASSET__assets_sounds_sfx_goal_mp3 extends null { }
@:keep class __ASSET__assets_sounds_sfx_hit_mp3 extends null { }
@:keep class __ASSET__assets_sounds_sfx_jump_mp3 extends null { }
@:keep class __ASSET__assets_sounds_sfx_powerup_mp3 extends null { }
@:keep class __ASSET__assets_sounds_sfx_spin_mp3 extends null { }
@:keep class __ASSET__assets_sounds_sfx_splash_mp3 extends null { }
@:keep class __ASSET__assets_sounds_sfx_wavebullet_mp3 extends null { }
@:keep class __ASSET__assets_sounds_shoot1_mp3 extends null { }
@:keep class __ASSET__assets_sounds_shoot2_mp3 extends null { }
@:keep class __ASSET__assets_sounds_shoot3_mp3 extends null { }
@:keep class __ASSET__assets_sounds_shoot_orca_mp3 extends null { }
@:keep class __ASSET__assets_sounds_shoot_player_mp3 extends null { }
